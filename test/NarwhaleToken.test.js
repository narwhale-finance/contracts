...
describe("NarwhaleToken", function () {
  ...
  it("should only allow owner to mint token", async function () {
    ...
    await expect(this.narwhale.connect(this.bob).mint(this.carol.address, "1000000000000000000000", { from: this.bob.address })).to.be.revertedWith(
  ...
  it("should fail if you try to do bad transfers", async function () {
    await this.narwhale.mint(this.alice.address, "100000000000000000000")
    await expect(this.narwhale.transfer(this.carol.address, "110000000000000000000")).to.be.revertedWith("ERC20: transfer amount exceeds balance")
